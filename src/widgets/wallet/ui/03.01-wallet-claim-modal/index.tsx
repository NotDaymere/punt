...
export const WalletClaimModal: React.FC<Props> = ({ 
    active, 
    onCancel, 
    onComplete 
}) => {
        ...
        return (
            <WalletInnerModal active={active}>
                <Image.Default
                    ...
                    alt=""
                />
                <Title.V2 className={css.claim_title}>
                    Confirm claiming
                </Title.V2>
    ...
    return (
        <WalletInnerModal active={active}>
            ...
            <p className={css.claim_text}>
                You are claiming 0,3 <Image.Default src="/img/icons/sc.svg" alt="sc" /> Sweeps Coins
                & 5 000 <Image.Default src="/img/icons/gc.svg" alt="gc" /> Gold Coins
            </p>
            <p className={css.claim_again}>
                You can only claim again after 24 Hrs.
            </p>
