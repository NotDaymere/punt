            ...
            <AuthSlider slide={step}>
                <AuthSlider.Slide>
                    ...
                    <p className={css.onboarding_text}>
                        You get a FREE 10000 Gold Coins on registration, for an additional 2 SC you
                        can complete the steps at https://punt.com/bonus
                    </p>
                    <Controls />
                </AuthSlider.Slide>
                <AuthSlider.Slide>
                    ...
                    <p className={css.onboarding_text}>
                        ...
                        currencies known as <Image.Default src="/img/icons/gc.svg" alt="" /> Gold
                        Coins and <Image.Default src="/img/icons/sc.svg" alt="" /> Sweep Coins.
                    </p>
                    <Controls />
                </AuthSlider.Slide>
                <AuthSlider.Slide>
                    ...
                    <p className={css.onboarding_text}>
                        Daily bonus is a recurring feature, available daily. This means you have the
                        chance to test your luck and enjoy the platform&apos;s offerings on a daily
                        basis, all without any charge.
                    </p>
                    <Controls />
                </AuthSlider.Slide>
                <AuthSlider.Slide>
